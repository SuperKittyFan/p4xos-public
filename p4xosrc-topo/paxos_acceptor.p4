...
action handle_2a() {
    modify_field(paxos.msgtype, PAXOS_2C);				          // Create a 2C message
    ...
    modify_field(intrinsic_metadata.mcast_grp, 0);                                // not multicasting
    register_write(rounds_register, paxos.instance, paxos.round);                 // rounds_register[paxos.instance] = paxos.round
...
table tbl_acceptor {
    ...
    actions { handle_1a; handle_2a; handle_2e; _nop; _drop; }
}
